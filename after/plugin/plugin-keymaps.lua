...
vim.keymap.set('n', '<Leader>s', telescope_builtin.live_grep, { desc = 'Telescope live grep' })
...
vim.keymap.set('n', '<Leader>gb', gitsigns.toggle_current_line_blame, { desc = 'Toggle git line blame' })
